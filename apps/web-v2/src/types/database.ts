...
export type EventRecurrenceType = 'none' | 'daily' | 'weekly' | 'biweekly' | 'monthly'
...
export interface Task {
  ...
  must_do: boolean
  mission_category_id: string | null
...
export interface CreateTaskInput {
  ...
  end_date?: string | null
  time_window_label?: string | null
  target_completions_per_period?: number | null
}
...
export type StreakTemplateKey = 'complete_n_filtered' | 'complete_any_filtered' | 'perfect_must_do' | 'complete_all_tasks' | 'earn_vp_target'
...
export interface GoalWithMissions extends Goal {
