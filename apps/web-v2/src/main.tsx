...
/**
 * AuthGate: Ensures auth initialization completes before rendering children.
 * Without this, the router could render protected routes before we know
 * whether the user is authenticated — a security vulnerability.
 */
