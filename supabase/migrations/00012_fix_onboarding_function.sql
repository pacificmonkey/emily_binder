-- Migration: 00012_fix_onboarding_function.sql
-- Description: Fix onboarding function to match actual schema
...
BEGIN
  ...
  -- 1. Create workspace (display_name, timezone_default)
  ...
  -- 3. Create patient profile (patient_id = user_id, full_name)
  ...
  -- 4. Create workspace membership (no patient_id column, uses joined_at)
